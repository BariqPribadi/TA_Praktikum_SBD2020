	...
	<?php
		if (isset($_POST["checkout"])) 
		{
			...
			foreach ($_SESSION["keranjang"] as $id_produk => $jumlah) 
			{
				...
				$koneksi->query("INSERT INTO pembelian_produk (id_pembelian,id_produk,jumlah,nama,harga,berat,subberat,subharga) VALUES ('$id_pembelian_barusan','$id_produk','$jumlah','$nama','$harga','$berat','$subberat','$subharga') ") or die(mysqli_error($koneksi));
			}
